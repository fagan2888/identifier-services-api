				...
				try {
					if (dbExpected) {
						...
						if (payload) {
							...
							return {descr, requestUrl, method, role, username, password, expectedStatus, expectedDb, payloadData};
						}
					...
					return {expectedPayload, descr, requestUrl, method, role, username, password, expectedStatus};
				} catch (err) {
					if (err.code === 'ENOENT') {
